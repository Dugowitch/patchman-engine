...
func TestSystemDelete(t *testing.T) {
	...
	w := managerTestUtils.CreateRequestRouterWithParams(
		"DELETE", "/:inventory_id", del, "rh_account_id=1", nil, "", SystemDeleteHandler, 1,
	)
...
func TestSystemDeleteWrongAccount(t *testing.T) {
	core.SetupTest(t)
	w := managerTestUtils.CreateRequestRouterWithParams(
		"DELETE", "/:inventory_id", del, "rh_account_id=1", nil, "", SystemDeleteHandler, 2,
	)
...
func TestSystemDeleteUnknown(t *testing.T) {
	core.SetupTest(t)
	w := managerTestUtils.CreateRequestRouterWithParams(
		"DELETE", "/:inventory_id", "unknownsystem", "rh_account_id=1", nil, "", SystemDeleteHandler, 1,
	)
