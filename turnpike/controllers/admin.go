...
// @Param    rh_account_id   query   string   true "Account ID"
// @Success 200
...
func SystemDeleteHandler(c *gin.Context) {
	account := c.Query("rh_account_id")
	if account == "" {
		utils.LogAndRespBadRequest(c, errors.New("bad request"), "rh_account_id query param not found")
		return
	}
