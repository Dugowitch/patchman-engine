...
func TestSystemTagsListDefault(t *testing.T) {
	...
	w := CreateRequestRouterWithAccount("GET", "/", "", "", nil, "", SystemTagListHandler, 1, c)
...
func TestSystemTagsListPagination(t *testing.T) {
	...
	w := CreateRequestRouterWithAccount("GET", "/", "", "?offset=1&limit=1", nil, "", SystemTagListHandler, 1, c)
...
func TestSystemTagsListSort(t *testing.T) {
	...
	w := CreateRequestRouterWithAccount("GET", "/", "", "?sort=count", nil, "", SystemTagListHandler, 1, c)
